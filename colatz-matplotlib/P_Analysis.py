...
# 5 different plots for 5 different p values
y0 = []
y1 = []
y2 = []
y3 = []
...
# Creating the multiplicity dictionary using the counter function,
# Creating the scatter plots and mean vertical lines
mean0 = statistics.mean(y0)
std0 = statistics.stdev(y0)
m0 = ctr(y0)
x0 = list(m0.keys())
y0 = list(m0.values())
plt.scatter(x0, y0, color=colors[0], s=1, label = r"$p = 1$")
...
x1 = list(m1.keys())
y1 = list(m1.values())
plt.scatter(x1, y1, color=colors[1], s=1, label = r"$p = 0.75$")
...
x3 = list(m3.keys())
y3 = list(m3.values())
plt.scatter(x3, y3, color=colors[3], s=1, label = r"$p = 0.25$")
...
x4 = list(m4.keys())
y4 = list(m4.values())
plt.scatter(x4, y4, color=colors[4], s=1, label = r"$p = 0$")
...
plt.title("Multiplicity of Probabilistic Collatz Lengths from 1 to 1,000,000", fontsize=16)
